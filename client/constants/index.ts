...
import { faShield,faLanguage,faLock,faHouse ,faCircleQuestion,faNotesMedical,faPen,faBook,faUser ,faCreditCard ,faFile,faBell, faHome   } from "@fortawesome/free-solid-svg-icons";
